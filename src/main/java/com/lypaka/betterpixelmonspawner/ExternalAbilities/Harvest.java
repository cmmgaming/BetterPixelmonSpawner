...
public class Harvest {
    ...
    public static LegendarySpawnInfo tryHarvestOnLegendary (LegendarySpawnInfo originalSpawn, List<LegendarySpawnInfo> possibleSpawns, EntityPlayerMP player) {
    ...
    public static PokemonSpawnInfo tryHarvestOnPokemon (PokemonSpawnInfo originalSpawn, List<PokemonSpawnInfo> possibleSpawns, EntityPlayerMP player) {
