...
public class PokemonSpawnInfo {
    ...
    public static Map<String, List<PokemonSpawnInfo>> infoMap = new HashMap<>();

    public PokemonSpawnInfo (String name, String biome, String time, String weather, String levelRange, String groupSize, String spawnChance, String spawnLocation, String texture, String heldItemID, boolean hostile) {
    ...
    public void register() {
        ...
        List<PokemonSpawnInfo> list = new ArrayList<>();
