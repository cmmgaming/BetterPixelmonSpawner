...
public class MagnetPull {
    ...
    public static LegendarySpawnInfo tryMagnetPullOnLegendary (LegendarySpawnInfo originalSpawn, List<LegendarySpawnInfo> possibleSpawns, EntityPlayerMP player) {
    ...
    public static PokemonSpawnInfo tryMagnetPullOnPokemon (PokemonSpawnInfo originalSpawn, List<PokemonSpawnInfo> possibleSpawns, EntityPlayerMP player) {
